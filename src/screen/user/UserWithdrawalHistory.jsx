  ...
  return (
    ...
    >
      ...
      >
        ...
        <DetailRow
          label="IFSC Code"
          value={withdrawal?.ifscCode?.toUpperCase()}
        />
        ...
        <DetailRow
          label="Fee"
          value={`₹${withdrawal?.feeAmount?.toFixed(2) || 0}`}
        />
        <DetailRow
          label="Requested On"
        ...
        {withdrawal?.approvedDate && (
          <DetailRow
            label="Approved On"
            value={dateFormatter(withdrawal?.approvedDate)}
          />
        )}
    ...
    <div className="space-y-3">
      {withdrawals.length === 0 ? (
        ...
        withdrawals.map((w) => (
          <div
            key={w?._id}
            className="bg-white shadow-sm border border-gray-300 rounded-2xl p-4 space-y-3"
          >
            ...
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-500">
                ...
                {w?.accountNumber
                  ?.slice(-4)
                  ?.padStart(w?.accountNumber?.length || 4, "•")}
              </span>
              <button
