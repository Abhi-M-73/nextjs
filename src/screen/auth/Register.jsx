...
const Register = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-white w-full px-4 py-10 overflow-hidden">
      {/* Subtle ambient tint, no blur glow */}
      <div className="pointer-events-none absolute -top-40 -right-32 w-96 h-96 bg-blue-50 rounded-full" />
      <div className="pointer-events-none absolute -bottom-40 -left-32 w-96 h-96 bg-indigo-50 rounded-full" />
      <div
      ...
      <div className="relative mx-auto rounded-3xl bg-white border border-gray-100 text-gray-900 max-w-[440px] w-full py-8">
          ...
          <div className="relative">
            ...
            <div className="w-full flex gap-2 items-start">
              <div className="w-[120px] shrink-0 relative">
                ...
                {open && (
                  <div className="absolute z-10 w-[280px] max-h-80 overflow-auto mt-2 rounded-xl border border-gray-200 bg-white text-gray-900 text-base">
