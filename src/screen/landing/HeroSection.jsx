...
const faqs = [
  {
    ...
    a: "No. Crypto assets are volatile. Any displayed rate is a target or program term and must not be considered a guaranteed return.",
  },
  {
    q: "How can I get started?",
    a: "Create your account, complete the applicable verification, review all terms and select an available option only after understanding the risks.",
  },
  {
...
export default function App() {
  ...
  border-radius: 13px;
        ...
        .dashboard {
          ...
          z-index: 2;
          padding: 22px;
          border: 1px solid rgba(225, 236, 248, .95);
          border-radius: 29px;
          background: rgba(255,255,255,.86);
          box-shadow: 0 28px 75px rgba(34, 74, 124, .14);
        ...
        .feature-card:hover {
          ...
          box-shadow: 0 22px 45px rgba(37, 76, 120, .1);
        }
      ...
      <main>
          ...
          <div className="container hero-grid">
            <div>
              <div className="eyebrow">
                ...
                Simple digital-asset access
              </div>

              <h1>
                A calmer way to explore <span>crypto.</span>
              </h1>

              <p className="hero-copy">
                Discover a cleaner digital-asset experience with understandable
                terms, thoughtful design and transparent information at every
                step.
              </p>
              ...
              <div className="hero-note">
                ...
                Clear information before participation
              </div>
            </div>
            ...
            <div className="dashboard-area">
              ...
              <div className="dashboard">
                <div className="dashboard-top">
                  <span className="dashboard-label">Portfolio overview</span>
        ...
        <section className="section soft-section">
          <div className="container">
            <div className="section-heading reveal">
              <div className="kicker">Why CalmVest</div>
              <h2>Designed for clarity, not complexity.</h2>
              <p>
                Every part of the experience helps users understand the
            ...
            <div className="feature-grid">
              <div className="feature-card reveal">
                ...
                <p>
                  View package details, fees, timelines and important conditions
                  in one clear place.
                </p>
              </div>
              ...
              <div className="feature-card reveal">
                ...
                <p>
                  Follow account activity with a clean dashboard and
              ...
              <div className="feature-card reveal">
                ...
                <p>
                  Make informed decisions with visible risk information and
        ...
        <section id="plans" className="section">
          <div className="container">
            <div className="section-heading reveal">
              <div className="kicker">Available options</div>
              <h2>Choose what fits your journey.</h2>
              <p>
              ...
              {plans.map((plan) => (
                ...
                >
                  ...
                  <div className="plan-rate">
                    {plan.rate} <span>target rate</span>
                  </div>
                  ...
                  <p className="plan-description">
                    Review the available information and all applicable
                    conditions before participation.
                  </p>
                  ...
                  <ul className="plan-list">
                    ...
                    <li>
                      ...
                      Applicable conditions disclosed
                    </li>
                  </ul>
          ...
          <div className="container process-grid">
            <div className="content-heading reveal">
              ...
              <div className="steps">
                ...
                <div className="step">
                  ...
                  <div>
                    <h3>Review a package</h3>
                    <p>Check amount range, timing, fees and conditions.</p>
                  </div>
                </div>
                ...
                <div className="step">
                  ...
                  <div>
                    ...
                    <p>Track activity according to the published terms.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="transparency" className="trust-card reveal">
              ...
              <div className="risk-note">
                Digital assets are volatile. Stated rates are not guaranteed
                returns, and participation may result in partial or complete
                loss of capital.
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="cta-box reveal">
              <div className="cta-content">
                <h2>Start with clarity. Move at your own pace.</h2>
                <p>
                  Explore the platform, review the terms and make an informed
                  decision before participating.
                </p>
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand">
              <p>
                A clean and transparent interface for exploring digital-asset
                participation.
              </p>
            </div>
          ...
          <div className="footer-bottom">
            ...
            <span>
              Crypto assets are volatile. This website does not provide
              financial advice.
            </span>
          </div>
        </div>
