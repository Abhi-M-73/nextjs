...
import { Sparkles, ArrowRight, Wallet, Users, TrendingUp, Clock } from "lucide-react";
...
const HeroSection = () => {
    ...
    const highlights = [
        ...
        { icon: Clock, label: "ID Validity", value: "90 Days" },
    ];
    ...
    return (
        <section
            ...
            <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center text-center py-10">
                ...
                >
                    Activate your ID at just ₹999 and unlock daily cashback, instant referral
                    income, and level income across 16 levels. Start as SILVER, upgrade to
                    GOLD after 10 direct referrals — withdraw anytime with just ₹700 minimum.
                </motion.p>
                ...
                >
                    ...
                    {/* Text */}
                    <Link to="/auth/register" className="relative z-10 flex items-center gap-2">
                        Activate Now
