                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 mb-6">
                            ...
                            <span className="text-sm font-medium text-purple-400">Discover The Plan</span>
                        </div>
                        ...
                        <div className="space-y-6 text-gray-400 font-light leading-relaxed text-[17px]">
                            <p>
                                ...
                                cashback, instant referral rewards, and deep level income
                                across a 16-tier network.
                            </p>
                            <p>
                                There's no market speculation involved — every payout is fixed,
                                calculated, and credited on schedule, so you always know
                                exactly what you're earning and when.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-x-8 gap-y-6 text-xs text-gray-400 mt-10">
                            <div>
                                <span className="block text-gray-500 mb-1">Cashback Period</span>
                            ...
                            <div>
                                <span className="block text-gray-500 mb-1">Active Days / Month</span>
                                ...
                                <div className="relative z-10 flex-1 flex flex-col">
                                    <div className="flex justify-between items-center mb-8">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-gray-300 font-medium">Earning Overview</span>
                                        </div>
                                    ...
                                    <div className="bg-black/50 p-6 rounded-2xl border border-white/5 flex-1">
                                        <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="font-bold text-white text-lg">Activation Package</h4>
                                                <p className="text-xs text-gray-400">SILVER Rank on Join</p>
                                            </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-xs text-gray-400 mt-6">
                                            <div>
                                                <span className="block text-gray-500 mb-1">Cashback Income</span>
                                                <span className="text-white font-medium">₹1,000</span>
                                            </div>
                                            <div>
                                                <span className="block text-gray-500 mb-1">Referral Income</span>
                                                <span className="text-white font-medium">₹100 / Referral</span>
                                            </div>
                                            <div>
                                                <span className="block text-gray-500 mb-1">Level Income (Total)</span>
                                                <span className="text-white font-medium">₹977</span>
                                            </div>
                                            <div>
                                                <span className="block text-gray-500 mb-1">Rank Upgrade</span>
                                                <span className="text-white font-medium">GOLD @ 10 Referrals</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="relative bg-[#0f0f12]/90 border border-white/10 rounded-[32px] p-8 backdrop-blur-xl h-full flex flex-col">
                                ...
                                <div className="relative z-10 flex-1 flex flex-col gap-6">
                                    <div className="flex justify-between items-center">
                                        <span className="text-gray-300 font-medium">Withdrawal & Validity</span>
                                    ...
                                    <div className="bg-black/50 p-6 rounded-2xl border border-white/5 flex-1">
                                        <div className="grid grid-cols-2 gap-y-6 gap-x-4 text-sm">
                                            <div>
                                                <p className="text-gray-500 text-xs mb-1">Minimum Withdrawal</p>
                                                <p className="text-white font-medium">₹700</p>
                                            </div>
                                            <div>
                                                <p className="text-gray-500 text-xs mb-1">Admin Charge</p>
                                                <p className="text-white font-medium">10%</p>
                                            </div>
                                            <div>
                                                <p className="text-gray-500 text-xs mb-1">ID Validity</p>
                                                <p className="text-white font-medium">90 Days</p>
                                            </div>
                                            <div>
                                                <p className="text-gray-500 text-xs mb-1">Renewal Fee</p>
                                    ...
                                    <div className="mt-auto rounded-2xl bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 flex items-center justify-between p-6">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs text-gray-500 mb-1">Payout Mode</p>
                                                <p className="text-sm font-medium text-white">Bank / UPI</p>
                                            </div>
                                        </div>
                                        <div className="text-right flex items-center gap-3">
                                            <div>
                                                <p className="text-xs text-purple-400 mb-1">Weekly Off</p>
                                                <p className="text-sm font-medium text-white">Every Sunday</p>
                                            </div>
