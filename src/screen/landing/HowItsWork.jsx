...
import { UserPlus, ChevronRight, Target, Wallet, Users, IndianRupee } from "lucide-react";
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
                    ...
                    {steps.map((item, index) => (
                        ...
                        >
                            {/* Outer Glow */}
                            <div
                                className={`absolute -inset-1 bg-gradient-to-r ${item.color} rounded-[34px] blur opacity-10 group-hover:opacity-30 transition duration-700`}
                            ></div>

                            <div className="relative h-full bg-[#0f0f12]/90 border border-white/10 rounded-[32px] p-7 backdrop-blur-xl overflow-hidden flex flex-col justify-between">
                                ...
                                <div className="relative z-10 flex-1">
                                    ...
                                    <div className="mb-8">
                                        <div
                                            className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500 p-[1px]`}
                                        >
