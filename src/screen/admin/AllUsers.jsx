  ...
  const columns = [
    ...
    },
    {
      ...
      render: (value) => {
        ...
        return (
          <span
            className={`text-xs font-semibold ${isExpired ? "text-rose-600" : "text-emerald-600"
              }`}
          >
            {days}
          </span>
      ...
      render: (_, row) => (
        <div className="flex items-center gap-2">
          <button
            ...
            className={`inline-flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-xs font-semibold transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${row?.isLoginBlocked
